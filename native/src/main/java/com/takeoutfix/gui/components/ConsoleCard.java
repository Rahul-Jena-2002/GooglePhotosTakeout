...
public class ConsoleCard extends JPanel {
    ...
    public ConsoleCard() {
        ...
        StyleConstants.setForeground(styleSuccess, new Color(16, 185, 129));
        ...
        StyleConstants.setForeground(styleWarn, new Color(245, 158, 11));
        ...
        StyleConstants.setForeground(styleDefault, new Color(129, 140, 248));
