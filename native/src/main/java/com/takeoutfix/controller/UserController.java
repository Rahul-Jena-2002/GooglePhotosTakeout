package com.takeoutfix.controller;

import com.takeoutfix.service.UserService;
...
public class UserController {
    ...
    public static void incrementUsage(long files, long bytes) {
        ...
        if (userService != null) {
            try {
                com.takeoutfix.model.User user = userService.getCurrentUser();
                if (user != null) {
    ...
    public static void syncUser(Map<String, Object> profile) {
        ...
        if (userService != null) {
            try {
                ...
                com.takeoutfix.model.User user = userService.loginOrCreateUser(googleId, email, name, picture);
                user.setPlan(plan);
